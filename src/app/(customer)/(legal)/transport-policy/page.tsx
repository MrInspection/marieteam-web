...
export default function TransportPolicyPage() {
  return (
    <>
      <BroadcastBanner
        message={"The content on this page is for demonstration purposes only and should not be considered an official document from MarieTeam."}
        variant={"error"}/>
      <article className="container max-w-3xl py-14">
        ...
        <section className="mt-10 mb-20">
          ...
          <p className="mt-6">The transport ticket is personal and non-transferable. It must be presented during
            boarding. No
          ...
          <p className="mt-6">MarieTeam is responsible for the safety and well-being of Passengers on board. We adhere
            to
          ...
          <p className="mt-6">Passengers must comply with safety rules and follow the instructions given by the onboard
            staff.
          ...
          <p className="mt-6">Each Passenger is entitled to a limited number of personal luggage, the dimensions and
            weight of
          ...
          <p className="mt-6">In accordance with Regulation (EC) No. 1177/2010, Passengers have the following
            rights:</p>
